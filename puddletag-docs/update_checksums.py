...
.. _source_link: http://sourceforge.net/projects/puddletag/files/puddletag-{version}.tar.gz
.. |deb_link| replace:: puddletag_{version}-{deb_version}_all.deb
.. _deb_link: http://sourceforge.net/projects/puddletag/files/puddletag_{version}-{deb_version}_all.deb
.. |deb_name| replace:: puddletag_{version}-{deb_version}_all.deb

.. |beta_source_link| replace:: puddletag-{version}.tar.gz
.. _beta_source_link: http://sourceforge.net/projects/puddletag/files/dev/puddletag-{version}.tar.gz
.. |beta_deb_link| replace:: puddletag_{version}-{deb_version}_all.deb
.. _beta_deb_link: http://sourceforge.net/projects/puddletag/files/dev/puddletag_{version}-{deb_version}_all.deb
